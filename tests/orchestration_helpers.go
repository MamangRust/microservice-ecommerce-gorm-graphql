...
func (s *BaseTestSuite) SetupBannerService() {
	...
	bannerRepos := banner_repo.NewRepositories(gormDB)
...
func (s *BaseTestSuite) SetupSliderService() {
	...
	sliderRepos := slider_repo.NewRepositories(gormDB)
...
func (s *BaseTestSuite) SetupProductService() {
	...
	prodRepos := product_repo.NewRepositories(gormDB, catQueryClient, merchantQueryClient)
...
func (s *BaseTestSuite) SetupCartService() {
	...
	cartRepos := cart_repo.NewRepositories(gormDB, userQueryClient, productQueryClient)
...
func (s *BaseTestSuite) SetupMerchantAwardService() {
	...
	awardRepos := merchant_award_repo.NewRepositories(gormDB, pb.NewMerchantQueryServiceClient(s.Conns["merchant"]))
...
func (s *BaseTestSuite) SetupMerchantBusinessService() {
	...
	businessRepos := merchant_business_repo.NewRepositories(gormDB, pb.NewMerchantQueryServiceClient(s.Conns["merchant"]))
...
func (s *BaseTestSuite) SetupMerchantDetailService() {
	...
	detailRepos := merchant_detail_repo.NewRepositories(gormDB, pb.NewMerchantQueryServiceClient(s.Conns["merchant"]))
...
func (s *BaseTestSuite) SetupMerchantPolicyService() {
	...
	policyRepos := merchant_policy_repo.NewRepositories(gormDB, pb.NewMerchantQueryServiceClient(s.Conns["merchant"]))
...
func (s *BaseTestSuite) SetupShippingAddressService() {
	...
	addrRepos := shipping_address_repo.NewRepositories(gormDB)
...
func (s *BaseTestSuite) SetupReviewService() {
	...
	userQueryClient := pb.NewUserQueryServiceClient(s.Conns["user"])
	productQueryClient := pb.NewProductQueryServiceClient(s.Conns["product"])
	reviewRepos := review_repo.NewRepositories(gormDB, userQueryClient, productQueryClient)
...
func (s *BaseTestSuite) SetupReviewDetailService() {
	...
	detailRepos := review_detail_repo.NewRepositories(gormDB)
