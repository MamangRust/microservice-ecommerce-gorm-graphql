...
func (s *MerchantPolicyApiTestSuite) TestMerchantPolicyNotFound() {
	resp, err := graphtest.ExecuteGraphQL(s.handler, "query { findMerchantPolicyById(input: { id: 999999 }) { status message } }", nil, "")
