...
func (s *MerchantDetailApiTestSuite) TestMerchantDetailNotFound() {
	resp, err := graphtest.ExecuteGraphQL(s.handler, "query { findMerchantDetailById(input: { id: 999999 }) { status message } }", nil, "")
