...
// FormatTimePtr converts *time.Time to formatted string.
...
// FormatTimePtrMS converts *time.Time to formatted string with milliseconds.
// Returns empty string if nil.
func FormatTimePtrMS(t *time.Time) string {
	if t == nil {
		return ""
	}
...
// FormatDatePtr converts *time.Time to date-only string.
// Returns empty string if nil.
