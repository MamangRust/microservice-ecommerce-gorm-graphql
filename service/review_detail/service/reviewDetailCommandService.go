...
func (s *reviewDetailCommandService) Create(ctx context.Context, req *requests.CreateReviewDetailRequest) (*models.ReviewDetail, error) {
	const method = "Create"
	...
	if err != nil {
		status = "error"
		return errorhandler.HandleError[*models.ReviewDetail](
			s.logger,
...
func (s *reviewDetailCommandService) Update(ctx context.Context, req *requests.UpdateReviewDetailRequest) (*models.ReviewDetail, error) {
	const method = "Update"
...
func (s *reviewDetailCommandService) Trash(ctx context.Context, review_id int) (*models.ReviewDetail, error) {
	const method = "Trash"
...
func (s *reviewDetailCommandService) Restore(ctx context.Context, review_id int) (*models.ReviewDetail, error) {
