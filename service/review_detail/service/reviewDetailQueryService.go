...
func (s *reviewDetailQueryService) FindAll(ctx context.Context, req *requests.FindAllReview) ([]*repository.ReviewDetailResult, *int, error) {
	...
	if err != nil {
		status = "error"
		return errorhandler.HandlerErrorPagination[[]*repository.ReviewDetailResult](
			s.logger,
...
func (s *reviewDetailQueryService) FindActive(ctx context.Context, req *requests.FindAllReview) ([]*repository.ReviewDetailResult, *int, error) {
...
func (s *reviewDetailQueryService) FindTrashed(ctx context.Context, req *requests.FindAllReview) ([]*repository.ReviewDetailResult, *int, error) {
...
func (s *reviewDetailQueryService) FindByID(ctx context.Context, review_id int) (*repository.ReviewDetailResult, error) {
	...
	if err != nil {
		status = "error"
		return errorhandler.HandleError[*repository.ReviewDetailResult](
			s.logger,
