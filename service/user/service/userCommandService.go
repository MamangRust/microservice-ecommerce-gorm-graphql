...
func (s *userCommandService) Create(ctx context.Context, request *requests.CreateUserRequest) (*models.User, error) {
	const method = "Create"
...
func (s *userCommandService) Update(ctx context.Context, request *requests.UpdateUserRequest) (*models.User, error) {
	const method = "Update"
...
func (s *userCommandService) Trash(ctx context.Context, user_id int) (*models.User, error) {
	const method = "Trash"
...
func (s *userCommandService) Restore(ctx context.Context, user_id int) (*models.User, error) {
...
func (s *userCommandService) UpdateIsVerified(ctx context.Context, user_id int, is_verified bool) (*models.User, error) {
...
func (s *userCommandService) UpdatePassword(ctx context.Context, user_id int, password string) (*models.User, error) {
