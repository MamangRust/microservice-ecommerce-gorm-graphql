...
func (s *passwordUpdateRepositoryStub) Create(context.Context, *requests.CreateUserRequest) (*models.User, error) {
	return nil, nil
}

func (s *passwordUpdateRepositoryStub) Update(context.Context, *requests.UpdateUserRequest) (*models.User, error) {
	return nil, nil
}

func (s *passwordUpdateRepositoryStub) UpdateIsVerified(context.Context, int, bool) (*models.User, error) {
	return nil, nil
}

func (s *passwordUpdateRepositoryStub) UpdatePassword(_ context.Context, userID int, password string) (*models.User, error) {
	s.userID = userID
	s.password = password
	return &models.User{
		UserID:    int32(userID),
...
func (s *passwordUpdateRepositoryStub) Trash(context.Context, int) (*models.User, error) {
	return nil, nil
}

func (s *passwordUpdateRepositoryStub) Restore(context.Context, int) (*models.User, error) {
	return nil, nil
}
