...
func (s *userQueryService) FindAll(ctx context.Context, req *requests.FindAllUsers) ([]*repository.UserResult, *int, error) {
	...
	if err != nil {
		status = "error"
		return errorhandler.HandlerErrorPagination[[]*repository.UserResult](
			s.logger,
	...
	logSuccess("Successfully fetched users",
...
func (s *userQueryService) FindActive(ctx context.Context, req *requests.FindAllUsers) ([]*repository.UserResult, *int, error) {
	...
	logSuccess("Successfully fetched active users",
		zap.Int("totalRecords", totalCount),
		zap.Int("page", page),
		zap.Int("pageSize", pageSize))
...
func (s *userQueryService) FindTrashed(ctx context.Context, req *requests.FindAllUsers) ([]*repository.UserResult, *int, error) {
	...
	logSuccess("Successfully fetched trashed users",
		zap.Int("totalRecords", totalCount),
		zap.Int("page", page),
		zap.Int("pageSize", pageSize))
