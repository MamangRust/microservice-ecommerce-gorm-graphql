...
func (s *productQueryService) FindAll(ctx context.Context, req *requests.FindAllProduct) ([]*repository.ProductResult, *int, error) {
	...
	if err != nil {
		status = "error"
		return errorhandler.HandlerErrorPagination[[]*repository.ProductResult](
			s.logger,
			err,
			method,
			span,
...
func (s *productQueryService) FindByMerchant(ctx context.Context, req *requests.FindAllProductByMerchant) ([]*repository.ProductResult, *int, error) {
...
func (s *productQueryService) FindByCategory(ctx context.Context, req *requests.FindAllProductByCategory) ([]*repository.ProductResult, *int, error) {
...
func (s *productQueryService) FindByID(ctx context.Context, productID int) (*repository.ProductResult, error) {
	...
	if err != nil {
		status = "error"
		return errorhandler.HandleError[*repository.ProductResult](
			s.logger,
			err,
			method,
			span,
...
func (s *productQueryService) FindActive(ctx context.Context, req *requests.FindAllProduct) ([]*repository.ProductResult, *int, error) {
...
func (s *productQueryService) FindTrashed(ctx context.Context, req *requests.FindAllProduct) ([]*repository.ProductResult, *int, error) {
