...
func (s *merchantSocialLinkCommandService) Create(ctx context.Context, req *requests.CreateMerchantSocialRequest) (*models.MerchantSocialMediaLink, error) {
	const method = "Create"
	...
	if err != nil {
		status = "error"
		return errorhandler.HandleError[*models.MerchantSocialMediaLink](
			s.logger,
...
func (s *merchantSocialLinkCommandService) Update(ctx context.Context, req *requests.UpdateMerchantSocialRequest) (*models.MerchantSocialMediaLink, error) {
	const method = "Update"
