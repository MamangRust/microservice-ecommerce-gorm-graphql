...
func (s *merchantDetailQueryService) FindAll(ctx context.Context, req *requests.FindAllMerchant) ([]*repository.MerchantDetailResult, *int, error) {
	...
	if data, total, found := s.cache.GetCachedMerchantDetailsAll(ctx, req); found {
	...
	if err != nil {
		status = "error"
		return errorhandler.HandlerErrorPagination[[]*repository.MerchantDetailResult](
			s.logger,
	...
	s.cache.SetCachedMerchantDetailsAll(ctx, req, res, &totalCount)

	logSuccess("Successfully fetched merchants", zap.Int("total", totalCount))
	return res, &totalCount, nil
}

func (s *merchantDetailQueryService) FindActive(ctx context.Context, req *requests.FindAllMerchant) ([]*repository.MerchantDetailResult, *int, error) {
	...
	if data, total, found := s.cache.GetCachedMerchantDetailsActive(ctx, req); found {
	...
	s.cache.SetCachedMerchantDetailsActive(ctx, req, res, &totalCount)

	logSuccess("Successfully fetched active merchants", zap.Int("total", totalCount))
	return res, &totalCount, nil
}

func (s *merchantDetailQueryService) FindTrashed(ctx context.Context, req *requests.FindAllMerchant) ([]*repository.MerchantDetailResult, *int, error) {
	...
	if data, total, found := s.cache.GetCachedMerchantDetailsTrashed(ctx, req); found {
	...
	s.cache.SetCachedMerchantDetailsTrashed(ctx, req, res, &totalCount)

	logSuccess("Successfully fetched trashed merchants", zap.Int("total", totalCount))
	return res, &totalCount, nil
}

func (s *merchantDetailQueryService) FindByID(ctx context.Context, merchantID int) (*repository.MerchantDetailResult, error) {
	...
	if err != nil {
		status = "error"
		return errorhandler.HandleError[*repository.MerchantDetailResult](
			s.logger,
