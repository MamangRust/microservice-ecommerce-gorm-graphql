...
func (s *merchantDetailCommandService) Create(ctx context.Context, req *requests.CreateMerchantDetailRequest) (*models.MerchantDetail, error) {
	const method = "Create"
	...
	if err != nil {
		status = "error"
		return errorhandler.HandleError[*models.MerchantDetail](
			s.logger,
			err,
			method,
			span,
...
func (s *merchantDetailCommandService) Update(ctx context.Context, req *requests.UpdateMerchantDetailRequest) (*models.MerchantDetail, error) {
	const method = "Update"
...
func (s *merchantDetailCommandService) Trash(ctx context.Context, merchantID int) (*models.MerchantDetail, error) {
	const method = "Trash"
...
func (s *merchantDetailCommandService) Restore(ctx context.Context, merchantID int) (*models.MerchantDetail, error) {
...
func (s *merchantDetailCommandService) DeletePermanent(ctx context.Context, merchantID int) (bool, error) {
	...
	detail, _ := s.merchantDetailRepository.Trash(ctx, merchantID)
