...
type IdentityCache interface {
	...
	SetCachedUserInfo(ctx context.Context, user *repository.AuthUser, expiration time.Duration)
	GetCachedUserInfo(ctx context.Context, userId string) (*repository.AuthUser, bool)
