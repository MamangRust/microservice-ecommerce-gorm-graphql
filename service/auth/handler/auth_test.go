...
func (registrationServiceStub) Register(context.Context, *requests.RegisterRequest) (*repository.AuthUser, error) {
	return nil, nil
}
...
func (identifyServiceStub) GetMe(context.Context, int) (*repository.AuthUser, error) {
	return nil, nil
}
