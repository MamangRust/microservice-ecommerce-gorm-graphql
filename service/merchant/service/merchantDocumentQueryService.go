...
func (s *merchantDocumentQueryService) FindAll(ctx context.Context, req *requests.FindAllMerchantDocuments) ([]*repository.MerchantDocumentResult, *int, error) {
	...
	if err != nil {
		status = "error"
		return errorhandler.HandlerErrorPagination[[]*repository.MerchantDocumentResult](
			s.logger,
			err,
			method,
			span,
...
func (s *merchantDocumentQueryService) FindByID(ctx context.Context, documentID int) (*repository.MerchantDocumentResult, error) {
	...
	if err != nil {
		status = "error"
		return errorhandler.HandleError[*repository.MerchantDocumentResult](
			s.logger,
			err,
			method,
			span,
...
func (s *merchantDocumentQueryService) FindActive(ctx context.Context, req *requests.FindAllMerchantDocuments) ([]*repository.MerchantDocumentResult, *int, error) {
...
func (s *merchantDocumentQueryService) FindTrashed(ctx context.Context, req *requests.FindAllMerchantDocuments) ([]*repository.MerchantDocumentResult, *int, error) {
