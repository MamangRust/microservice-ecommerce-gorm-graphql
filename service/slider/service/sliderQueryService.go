...
func (s *sliderQueryService) FindAll(ctx context.Context, req *requests.FindAllSlider) ([]*repository.SliderResult, *int, error) {
	const method = "FindAll"
	ctx, span, end, status, logSuccess := s.observability.StartTracingAndLogging(ctx, method,
		attribute.Int("page", req.Page), attribute.Int("pageSize", req.PageSize), attribute.String("search", req.Search))
	...
	if err != nil {
		status = "error"
		return errorhandler.HandlerErrorPagination[[]*repository.SliderResult](s.logger, err, method, span,
...
func (s *sliderQueryService) FindActive(ctx context.Context, req *requests.FindAllSlider) ([]*repository.SliderResult, *int, error) {
...
func (s *sliderQueryService) FindByID(ctx context.Context, slider_id int) (*repository.SliderResult, error) {
	...
	if err != nil {
		status = "error"
		return errorhandler.HandleError[*repository.SliderResult](s.logger, err, method, span, zap.Int("slider_id", slider_id))
	}
...
func (s *sliderQueryService) FindTrashed(ctx context.Context, req *requests.FindAllSlider) ([]*repository.SliderResult, *int, error) {
