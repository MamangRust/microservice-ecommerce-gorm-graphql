...
func (s *merchantBusinessCommandService) Create(ctx context.Context, req *requests.CreateMerchantBusinessInformationRequest) (*models.MerchantBusinessInformation, error) {
	const method = "Create"
	...
	if err != nil {
		status = "error"
		return errorhandler.HandleError[*models.MerchantBusinessInformation](
			s.logger,
...
func (s *merchantBusinessCommandService) Update(ctx context.Context, req *requests.UpdateMerchantBusinessInformationRequest) (*models.MerchantBusinessInformation, error) {
	const method = "Update"
...
func (s *merchantBusinessCommandService) Trash(ctx context.Context, merchantID int) (*models.MerchantBusinessInformation, error) {
	const method = "Trash"
...
func (s *merchantBusinessCommandService) Restore(ctx context.Context, merchantID int) (*models.MerchantBusinessInformation, error) {
