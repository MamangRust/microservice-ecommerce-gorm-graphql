...
func (s *merchantBusinessQueryService) FindAll(ctx context.Context, req *requests.FindAllMerchant) ([]*repository.MerchantBusinessResult, *int, error) {
	...
	if err != nil {
		status = "error"
		return errorhandler.HandlerErrorPagination[[]*repository.MerchantBusinessResult](
			s.logger,
...
func (s *merchantBusinessQueryService) FindActive(ctx context.Context, req *requests.FindAllMerchant) ([]*repository.MerchantBusinessResult, *int, error) {
...
func (s *merchantBusinessQueryService) FindTrashed(ctx context.Context, req *requests.FindAllMerchant) ([]*repository.MerchantBusinessResult, *int, error) {
...
func (s *merchantBusinessQueryService) FindByID(ctx context.Context, merchantID int) (*repository.MerchantBusinessResult, error) {
	...
	if err != nil {
		...
		if errors.Is(err, merchantbusiness_errors.ErrMerchantBusinessNotFound) {
			return errorhandler.HandleError[*repository.MerchantBusinessResult](
				s.logger,
