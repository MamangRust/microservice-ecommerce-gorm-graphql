...
func (s *roleQueryService) FindAll(ctx context.Context, req *requests.FindAllRole) ([]*repository.RoleResult, *int, error) {
	...
	if err != nil {
		status = "error"
		return errorhandler.HandlerErrorPagination[[]*repository.RoleResult](
			s.logger,
...
func (s *roleQueryService) FindActive(ctx context.Context, req *requests.FindAllRole) ([]*repository.RoleResult, *int, error) {
...
func (s *roleQueryService) FindTrashed(ctx context.Context, req *requests.FindAllRole) ([]*repository.RoleResult, *int, error) {
