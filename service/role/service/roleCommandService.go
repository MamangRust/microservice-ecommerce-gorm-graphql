...
func (s *roleCommandService) Create(ctx context.Context, request *requests.CreateRoleRequest) (*models.Role, error) {
	const method = "Create"
...
func (s *roleCommandService) Update(ctx context.Context, request *requests.UpdateRoleRequest) (*models.Role, error) {
	const method = "Update"
...
func (s *roleCommandService) Trash(ctx context.Context, id int) (*models.Role, error) {
	const method = "Trash"
...
func (s *roleCommandService) Restore(ctx context.Context, id int) (*models.Role, error) {
