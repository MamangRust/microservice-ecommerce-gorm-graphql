...
func (s *merchantPoliciesQueryService) FindAll(ctx context.Context, req *requests.FindAllMerchant) ([]*repository.MerchantPolicyResult, *int, error) {
	...
	if err != nil {
		status = "error"
		return errorhandler.HandlerErrorPagination[[]*repository.MerchantPolicyResult](
			s.logger,
...
func (s *merchantPoliciesQueryService) FindActive(ctx context.Context, req *requests.FindAllMerchant) ([]*repository.MerchantPolicyResult, *int, error) {
...
func (s *merchantPoliciesQueryService) FindTrashed(ctx context.Context, req *requests.FindAllMerchant) ([]*repository.MerchantPolicyResult, *int, error) {
...
func (s *merchantPoliciesQueryService) FindByID(ctx context.Context, id int) (*repository.MerchantPolicyResult, error) {
	...
	if err != nil {
		...
		if errors.Is(err, merchant_policy_errors.ErrMerchantPolicyNotFound) {
			return errorhandler.HandleError[*repository.MerchantPolicyResult](
				s.logger,
