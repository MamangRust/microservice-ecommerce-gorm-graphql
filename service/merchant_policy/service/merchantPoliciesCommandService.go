...
func (s *merchantPoliciesCommandService) Create(ctx context.Context, req *requests.CreateMerchantPolicyRequest) (*models.MerchantPolicy, error) {
	const method = "Create"
	...
	if err != nil {
		status = "error"
		return errorhandler.HandleError[*models.MerchantPolicy](
			s.logger,
...
func (s *merchantPoliciesCommandService) Update(ctx context.Context, req *requests.UpdateMerchantPolicyRequest) (*models.MerchantPolicy, error) {
	const method = "Update"
...
func (s *merchantPoliciesCommandService) Trash(ctx context.Context, id int) (*models.MerchantPolicy, error) {
	const method = "Trash"
...
func (s *merchantPoliciesCommandService) Restore(ctx context.Context, id int) (*models.MerchantPolicy, error) {
