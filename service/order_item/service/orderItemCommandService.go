...
func (s *orderItemCommandService) Create(ctx context.Context, req *requests.CreateOrderItemRecordRequest) (*models.OrderItem, error) {
	const method = "Create"
	...
	if err != nil {
		status = "error"
		return errorhandler.HandleError[*models.OrderItem](
			s.logger,
...
func (s *orderItemCommandService) Update(ctx context.Context, req *requests.UpdateOrderItemRecordRequest) (*models.OrderItem, error) {
	const method = "Update"
...
func (s *orderItemCommandService) Trash(ctx context.Context, orderItemID int) (*models.OrderItem, error) {
	const method = "Trash"
...
func (s *orderItemCommandService) Restore(ctx context.Context, orderItemID int) (*models.OrderItem, error) {
