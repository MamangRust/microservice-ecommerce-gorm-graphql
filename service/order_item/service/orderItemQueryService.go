...
func (s *orderItemQueryService) FindAll(ctx context.Context, req *requests.FindAllOrderItems) ([]*repository.OrderItemResult, *int, error) {
	...
	if err != nil {
		status = "error"
		return errorhandler.HandlerErrorPagination[[]*repository.OrderItemResult](
			s.logger,
...
func (s *orderItemQueryService) FindActive(ctx context.Context, req *requests.FindAllOrderItems) ([]*repository.OrderItemResult, *int, error) {
...
func (s *orderItemQueryService) FindTrashed(ctx context.Context, req *requests.FindAllOrderItems) ([]*repository.OrderItemResult, *int, error) {
...
func (s *orderItemQueryService) FindByOrder(ctx context.Context, orderID int) ([]*repository.OrderItemResult, error) {
	...
	if err != nil {
		status = "error"
		return errorhandler.HandleError[[]*repository.OrderItemResult](
			s.logger,
