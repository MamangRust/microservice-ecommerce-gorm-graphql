...
type shippingAddressCacheResponse struct {
	Data  []*repository.ShippingAddressResult `json:"data"`
...
func (r *shippingAddressQueryCache) GetShippingAddressAllCache(ctx context.Context, req *requests.FindAllShippingAddress) ([]*repository.ShippingAddressResult, *int, bool) {
