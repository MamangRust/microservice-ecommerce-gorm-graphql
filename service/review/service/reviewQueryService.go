...
func (s *reviewQueryService) FindAll(ctx context.Context, req *requests.FindAllReview) ([]*repository.ReviewResult, *int, error) {
	...
	if err != nil {
		status = "error"
		return errorhandler.HandlerErrorPagination[[]*repository.ReviewResult](
			s.logger,
...
func (s *reviewQueryService) FindActive(ctx context.Context, req *requests.FindAllReview) ([]*repository.ReviewResult, *int, error) {
...
func (s *reviewQueryService) FindTrashed(ctx context.Context, req *requests.FindAllReview) ([]*repository.ReviewResult, *int, error) {
...
func (s *reviewQueryService) FindByProduct(ctx context.Context, req *requests.FindAllReviewByProduct) ([]*repository.ReviewResult, *int, error) {
...
func (s *reviewQueryService) FindByMerchant(ctx context.Context, req *requests.FindAllReviewByMerchant) ([]*repository.ReviewResult, *int, error) {
...
func (s *reviewQueryService) FindByID(ctx context.Context, id int) (*repository.ReviewResult, error) {
	...
	if err != nil {
		status = "error"
		return errorhandler.HandleError[*repository.ReviewResult](
			s.logger,
