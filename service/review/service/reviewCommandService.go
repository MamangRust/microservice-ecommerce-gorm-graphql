...
func (s *reviewCommandService) Create(ctx context.Context, req *requests.CreateReviewRequest) (*models.Review, error) {
	const method = "Create"
	...
	if err != nil {
		status = "error"
		return errorhandler.HandleError[*models.Review](
			s.logger,
...
func (s *reviewCommandService) Update(ctx context.Context, req *requests.UpdateReviewRequest) (*models.Review, error) {
	const method = "Update"
...
func (s *reviewCommandService) Trash(ctx context.Context, reviewID int) (*models.Review, error) {
	const method = "Trash"
...
func (s *reviewCommandService) Restore(ctx context.Context, reviewID int) (*models.Review, error) {
