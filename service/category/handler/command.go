...
func NewCategoryCommandHandler(service service.CategoryCommandService, logger logger.LoggerInterface) pb.CategoryCommandServiceServer {
	return &categoryCommandHandler{service: service, logger: logger}
}
...
func (h *categoryCommandHandler) Create(ctx context.Context, request *pb.CreateCategoryRequest) (*pb.ApiResponseCategory, error) {
	...
	return &pb.ApiResponseCategory{Status: "success", Message: "Successfully created category", Data: (&Handler{}).mapToCategoryResponseFromModel(category)}, nil
}
...
func (h *categoryCommandHandler) Update(ctx context.Context, request *pb.UpdateCategoryRequest) (*pb.ApiResponseCategory, error) {
	...
	return &pb.ApiResponseCategory{Status: "success", Message: "Successfully updated category", Data: (&Handler{}).mapToCategoryResponseFromModel(category)}, nil
}
...
func (h *categoryCommandHandler) TrashedCategory(ctx context.Context, request *pb.FindByIdCategoryRequest) (*pb.ApiResponseCategoryDeleteAt, error) {
	...
	return &pb.ApiResponseCategoryDeleteAt{Status: "success", Message: "Successfully trashed category", Data: (&Handler{}).mapToDeleteAtResponseFromModel(category)}, nil
}
...
func (h *categoryCommandHandler) RestoreCategory(ctx context.Context, request *pb.FindByIdCategoryRequest) (*pb.ApiResponseCategoryDeleteAt, error) {
	...
	if err != nil { return nil, category_errors.ErrGrpcCategoryNotFound }
	return &pb.ApiResponseCategoryDeleteAt{Status: "success", Message: "Successfully restored category", Data: (&Handler{}).mapToDeleteAtResponseFromModel(category)}, nil
}
...
func (h *categoryCommandHandler) RestoreAllCategory(ctx context.Context, _ *emptypb.Empty) (*pb.ApiResponseCategoryAll, error) {
	...
	if err != nil { return nil, category_errors.ErrGrpcCategoryNotFound }
	return &pb.ApiResponseCategoryAll{Status: "success", Message: "Successfully restored all categories"}, nil
}
...
func (h *categoryCommandHandler) DeleteAllCategoryPermanent(ctx context.Context, _ *emptypb.Empty) (*pb.ApiResponseCategoryAll, error) {
	...
	if err != nil { return nil, errors.ToGrpcError(err) }
	return &pb.ApiResponseCategoryAll{Status: "success", Message: "Successfully deleted all categories permanently"}, nil
}
