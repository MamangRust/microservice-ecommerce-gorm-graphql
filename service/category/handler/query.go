...
func NewCategoryQueryHandler(service service.CategoryQueryService, logger logger.LoggerInterface) pb.CategoryQueryServiceServer {
	return &categoryQueryHandler{service: service, logger: logger}
}
...
func (h *categoryQueryHandler) FindAll(ctx context.Context, request *pb.FindAllCategoryRequest) (*pb.ApiResponsePaginationCategory, error) {
	...
	paginationMeta := &pb.PaginationMeta{
		...
		TotalPages: int32(math.Ceil(float64(*totalRecords) / float64(pageSize))), TotalRecords: int32(*totalRecords),
	}
	results := make([]*pb.CategoryResponse, len(categories))
	for i, v := range categories {
		results[i] = (&Handler{}).mapToCategoryResponseFromResult(v)
	}
	return &pb.ApiResponsePaginationCategory{Status: "success", Message: "Successfully fetched categories", Data: results, Pagination: paginationMeta}, nil
}
...
func (h *categoryQueryHandler) FindById(ctx context.Context, request *pb.FindByIdCategoryRequest) (*pb.ApiResponseCategory, error) {
	...
	return &pb.ApiResponseCategory{Status: "success", Message: "Successfully fetched category", Data: (&Handler{}).mapToCategoryResponseFromModel(category)}, nil
}
...
func (h *categoryQueryHandler) FindByActive(ctx context.Context, request *pb.FindAllCategoryRequest) (*pb.ApiResponsePaginationCategoryDeleteAt, error) {
	...
	for i, v := range categories {
		results[i] = (&Handler{}).mapToDeleteAtResponseFromResult(v)
	}
	return &pb.ApiResponsePaginationCategoryDeleteAt{Status: "success", Message: "Successfully fetched active categories", Data: results, Pagination: paginationMeta}, nil
}
...
func (h *categoryQueryHandler) FindByTrashed(ctx context.Context, request *pb.FindAllCategoryRequest) (*pb.ApiResponsePaginationCategoryDeleteAt, error) {
	...
	return &pb.ApiResponsePaginationCategoryDeleteAt{Status: "success", Message: "Successfully fetched trashed categories", Data: results, Pagination: paginationMeta}, nil
}
