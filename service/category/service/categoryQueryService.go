...
func NewCategoryQueryService(deps *CategoryQueryServiceDeps) *categoryQueryService {
...
func (s *categoryQueryService) FindAll(ctx context.Context, req *requests.FindAllCategory) ([]*repository.CategoryResult, *int, error) {
	...
	if err != nil {
		status = "error"
		return errorhandler.HandlerErrorPagination[[]*repository.CategoryResult](s.logger, err, method, span,
	...
	logSuccess("Successfully fetched all categories", zap.Int("totalRecords", totalCount), zap.Int("page", page), zap.Int("pageSize", pageSize))
	return categories, &totalCount, nil
}

func (s *categoryQueryService) FindActive(ctx context.Context, req *requests.FindAllCategory) ([]*repository.CategoryResult, *int, error) {
...
func (s *categoryQueryService) FindTrashed(ctx context.Context, req *requests.FindAllCategory) ([]*repository.CategoryResult, *int, error) {
...
func (s *categoryQueryService) FindByID(ctx context.Context, category_id int) (*models.Category, error) {
	...
	ctx, span, end, status, logSuccess := s.observability.StartTracingAndLogging(ctx, method, attribute.Int("category_id", category_id))
	defer func() { end(status) }()
	...
	if err != nil {
		status = "error"
		return errorhandler.HandleError[*models.Category](s.logger, err, method, span, zap.Int("category_id", category_id))
	}
