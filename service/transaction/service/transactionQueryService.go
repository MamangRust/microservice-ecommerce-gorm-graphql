...
func (s *transactionQueryService) FindAll(ctx context.Context, req *requests.FindAllTransaction) ([]*repository.TransactionResult, *int, error) {
	...
	if err != nil {
		status = "error"
		return errorhandler.HandlerErrorPagination[[]*repository.TransactionResult](
			s.logger,
			err,
			method,
			span,
...
func (s *transactionQueryService) FindByMerchant(ctx context.Context, req *requests.FindAllTransactionByMerchant) ([]*repository.TransactionResult, *int, error) {
...
func (s *transactionQueryService) FindActive(ctx context.Context, req *requests.FindAllTransaction) ([]*repository.TransactionResult, *int, error) {
...
func (s *transactionQueryService) FindTrashed(ctx context.Context, req *requests.FindAllTransaction) ([]*repository.TransactionResult, *int, error) {
...
func (s *transactionQueryService) FindByID(ctx context.Context, transactionID int) (*repository.TransactionResult, error) {
	...
	if err != nil {
		status = "error"
		return errorhandler.HandleError[*repository.TransactionResult](
			s.logger,
			err,
			method,
			span,
...
func (s *transactionQueryService) FindByOrderID(ctx context.Context, orderID int) (*repository.TransactionResult, error) {
