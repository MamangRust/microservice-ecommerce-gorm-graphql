...
func (s *orderQueryService) FindAll(ctx context.Context, req *requests.FindAllOrder) ([]*repository.OrderResult, *int, error) {
	...
	if err != nil {
		status = "error"
		return errorhandler.HandlerErrorPagination[[]*repository.OrderResult](
			s.logger,
			err,
			method,
			span,
...
func (s *orderQueryService) FindActive(ctx context.Context, req *requests.FindAllOrder) ([]*repository.OrderResult, *int, error) {
...
func (s *orderQueryService) FindTrashed(ctx context.Context, req *requests.FindAllOrder) ([]*repository.OrderResult, *int, error) {
...
func (s *orderQueryService) FindByMerchant(ctx context.Context, req *requests.FindAllOrderByMerchant) ([]*repository.OrderResult, *int, error) {
...
func (s *orderQueryService) FindByID(ctx context.Context, orderID int) (*models.Order, error) {
	...
	if err != nil {
		status = "error"
		return errorhandler.HandleError[*models.Order](
			s.logger,
			err,
			method,
			span,
